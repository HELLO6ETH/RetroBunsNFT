...
export default function Home() {
  ...
  const contract = getContract({
    client: client,
    chain: chain,
    address: "0xCD4Cda48F50D2e8F979f707c0a8E245e7445EC70"
  });
  ...
  const {data: claimedSupply, isLoading: isClamiedSupplyLoading} = useReadContract( getTotalClaimedSupply,
    { contract: contract}
  );
        ...
        <div className="flex flex-col items-center mt-4">
          {isContractMetadataLoading ? (
            ...
            <p className="text-lg mt-2">
              Pixel Sytle HotDog NFT's revealing on June 30th
            </p>
            </>
          )}
          {isClamiedSupplyLoading || isTotalSupplyLoading? (
            <p>Loading...</p>
          ):(
          ...
          <div className="flex felx-row items-center justify-center my-4">
            <button 
